!(function() {
        ...
        _doProcessBlock: function(t, e) {
          for (
            ...
            (u = ((r << 5) | (r >>> 27)) + c + s[h]),
              (u =
                20 > h
                  ? u + (1518500249 + ((i & o) | (~i & a)))
                  : 40 > h
                  ? u + (1859775393 + (i ^ o ^ a))
                  : 60 > h
                  ? u + (((i & o) | (i & a) | (o & a)) - 1894007588)
                  : u + ((i ^ o ^ a) - 899497514)),
              (c = a),
              (a = o),
              (o = (i << 30) | (i >>> 2)),
    ...
    (function() {
      ...
      t.enc.Base64 = {
          ...
          for (var i = [], s = 0; s < n; s += 3)
            for (
              var o = (e[s >>> 2] >>> (24 - (s % 4) * 8)) & 255,
                ...
                c = (e[(s + 2) >>> 2] >>> (24 - ((s + 2) % 4) * 8)) & 255,
                h = (o << 16) | (a << 8) | c,
                u = 0;
              u < 4 && s + 0.75 * u < n;
              u++
            )
              i.push(r.charAt((h >>> (6 * (3 - u))) & 63));
          var f = r.charAt(64);
        ...
        parse: function(t) {
          ...
          for (var o = [], a = 0, c = 0; c < e; c++)
            if (c % 4) {
              var h = n.indexOf(t.charAt(c - 1)) << ((c % 4) * 2),
  ...
  var n = function(t) {
      var n = t.Pathname || '/',
        ...
        o = t.Bucket.match(/^(.+)-(\d+)$/);
      o && ((i = o[1]), (s = o[2]));
      var a = parseInt(Math.random() * Math.pow(2, 32)),
        c = parseInt(Date.now() / 1e3),
        h = c + (void 0 === r ? 900 : 1 * r || 0),
        u = '/' + s + '/' + i + encodeURIComponent(n).replace(/%2F/g, '/'),
        f =
          'a=' +
          s +
          '&b=' +
          ...
          '&f=' +
          u,
        l = e.HmacSHA1(f, t.SecretKey),
        p = e.enc.Utf8.parse(f);
      return l.concat(p).toString(e.enc.Base64);
    },
    r = function(r) {
      if (!r.SecretId) return console.error('missing param SecretId');
      if (!r.SecretKey) return console.error('missing param SecretKey');
      if ('4.0' === r.Version) return n(r);
      r = r || {};
      var i = r.SecretId,
        s = r.SecretKey,
        o = (r.Method || 'get').toLowerCase(),
        a = r.Query || {},
        c = r.Headers || {},
        h = r.Pathname || '/',
        u = r.Expires,
        ...
        p = parseInt(new Date().getTime() / 1e3) - 1,
        d = p + (void 0 === u ? 900 : 1 * u || 0),
        g = i,
        y = p + ';' + d,
        v = p + ';' + d,
        m = f(c)
      ...
      return [
        ...
        'q-header-list=' + m,
        'q-url-param-list=' + _,
        'q-signature=' + e.HmacSHA1(B, w).toString()
      ].join('&');
    };
  'object' == typeof module ? (module.exports = r) : (window.CosAuth = r);
})();
