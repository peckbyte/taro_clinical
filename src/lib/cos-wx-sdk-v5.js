!(function(e, t) {
  ...
  return (function(e) {
    ...
    return (
      ...
      (t.p = 'D:\\github\\cos-wx-sdk-v5\\demo\\lib'),
      t((t.s = 4))
    );
  })([
    function(e, t, n) {
      ...
      var d = n(8),
        ...
        y = function(e) {
          ...
          var u = function(e) {
            ...
            d = Math.round(E(e.SystemClockOffset) / 1e3) - 1,
            h = d,
          ...
          return [
            ...
            'q-header-list=' + C,
            'q-url-param-list=' + v,
            'q-signature=' + f.HmacSHA1(S, x).toString()
          ].join('&');
        },
        C = function() {},
        v = function(e) {
        ...
        T = function(e, t) {
          return function(n, r) {
            ...
            if ('getService' !== e && 'abortUploadTask' !== e) {
              var a;
              if ((a = b(e, n))) return void i({ error: 'missing param ' + a });
              if (n.Region) {
                ...
                if (!/^([a-z\d-]+)$/.test(n.Region))
                  return void i({ error: 'Region format error.' });
          ...
          function n() {
            if (((o = 0), t && 'function' == typeof t)) {
              ...
              var n,
                i = Math.max(
                  0,
                  Math.round(((s - a) / ((r - c) / 1e3)) * 100) / 100
                );
              (n =
                0 === s && 0 === e ? 1 : Math.round((s / e) * 100) / 100 || 0),
                (c = r),
                (a = s);
              try {
      ...
      (N.fileSlice = function(e, t, n) {
        ...
        (N.getFileUUID = function(e, t) {
          return e.name && e.size && e.lastModifiedDate && t
            ? N.md5([e.name, e.size, e.lastModifiedDate, t].join('::'))
            : null;
        }),
    ...
    function(e, t) {
          ...
          case q:
            ...
            for (var u = 0; u < a; u++) {
              ...
              'xmlns' == l.prefix
                ...
                : 'xmlns' == l.nodeName &&
                  o.push({ prefix: '', namespace: l.value });
            }
            for (var u = 0; u < a; u++) {
              var l = i.item(u);
              if (L(l, n, o)) {
            ...
            if (s || (n && !/^(?:meta|link|img|br|hr|input)$/i.test(c))) {
              if ((t.push('>'), n && /^script$/i.test(c)))
                for (; s; )
                  s.data ? t.push(s.data) : F(s, t, n, r, o),
                    (s = s.nextSibling);
      ...
      function j(e, t, n) {
        ...
        switch (
          (t.childNodes && (r.childNodes = new i()),
          (r.ownerDocument = e),
          r.nodeType)
        ) {
          case q:
        ...
        switch (e.nodeType) {
          ...
          case te:
            ...
            for (e = e.firstChild; e; )
              7 !== e.nodeType && 8 !== e.nodeType && t.push(H(e)),
                (e = e.nextSibling);
            return t.join('');
          default:
            return e.nodeValue;
      ...
      (o.prototype = Error.prototype),
          ...
          getElementById: function(e) {
            ...
            return (
              m(this.documentElement, function(n) {
                if (n.nodeType == q && n.getAttribute('id') == e)
                  return (t = n), !0;
              }),
              t
            );
        ...
        (g.prototype.getElementsByTagName = A.prototype.getElementsByTagName),
        (g.prototype.getElementsByTagNameNS =
          A.prototype.getElementsByTagNameNS),
        r(A, h),
        ...
        r(T, R),
        (w.prototype = { nodeName: '#comment', nodeType: Y }),
        r(w, R),
        (_.prototype = { nodeName: '#cdata-section', nodeType: $ }),
        r(_, R),
        (E.prototype.nodeType = ee),
        r(E, h),
        (N.prototype.nodeType = ne),
        r(N, h),
        (B.prototype.nodeType = Q),
        r(B, h),
        (D.prototype.nodeType = W),
        r(D, h),
        (O.prototype.nodeName = '#document-fragment'),
        (O.prototype.nodeType = te),
        r(O, h),
        (P.prototype.nodeType = Z),
        r(P, h),
      ...
      var n = function(e) {
        ...
        for (
          ...
          (h = y),
            ...
            (m = v),
            (g = x),
            (y = s(y, C, v, x, k[f + 0], 7, 3614090360)),
            (x = s(x, y, C, v, k[f + 1], 12, 3905402710)),
            (v = s(v, x, y, C, k[f + 2], 17, 606105819)),
            (C = s(C, v, x, y, k[f + 3], 22, 3250441966)),
            (y = s(y, C, v, x, k[f + 4], 7, 4118548399)),
            (x = s(x, y, C, v, k[f + 5], 12, 1200080426)),
            (v = s(v, x, y, C, k[f + 6], 17, 2821735955)),
            (C = s(C, v, x, y, k[f + 7], 22, 4249261313)),
            (y = s(y, C, v, x, k[f + 8], 7, 1770035416)),
            (x = s(x, y, C, v, k[f + 9], 12, 2336552879)),
            (v = s(v, x, y, C, k[f + 10], 17, 4294925233)),
            (C = s(C, v, x, y, k[f + 11], 22, 2304563134)),
            (y = s(y, C, v, x, k[f + 12], 7, 1804603682)),
            (x = s(x, y, C, v, k[f + 13], 12, 4254626195)),
            (v = s(v, x, y, C, k[f + 14], 17, 2792965006)),
            (C = s(C, v, x, y, k[f + 15], 22, 1236535329)),
            (y = c(y, C, v, x, k[f + 1], 5, 4129170786)),
            (x = c(x, y, C, v, k[f + 6], 9, 3225465664)),
            (v = c(v, x, y, C, k[f + 11], 14, 643717713)),
            (C = c(C, v, x, y, k[f + 0], 20, 3921069994)),
            (y = c(y, C, v, x, k[f + 5], 5, 3593408605)),
            (x = c(x, y, C, v, k[f + 10], 9, 38016083)),
            (v = c(v, x, y, C, k[f + 15], 14, 3634488961)),
            (C = c(C, v, x, y, k[f + 4], 20, 3889429448)),
            (y = c(y, C, v, x, k[f + 9], 5, 568446438)),
            (x = c(x, y, C, v, k[f + 14], 9, 3275163606)),
            (v = c(v, x, y, C, k[f + 3], 14, 4107603335)),
            (C = c(C, v, x, y, k[f + 8], 20, 1163531501)),
            (y = c(y, C, v, x, k[f + 13], 5, 2850285829)),
            (x = c(x, y, C, v, k[f + 2], 9, 4243563512)),
            (v = c(v, x, y, C, k[f + 7], 14, 1735328473)),
            (C = c(C, v, x, y, k[f + 12], 20, 2368359562)),
            (y = u(y, C, v, x, k[f + 5], 4, 4294588738)),
            (x = u(x, y, C, v, k[f + 8], 11, 2272392833)),
            (v = u(v, x, y, C, k[f + 11], 16, 1839030562)),
            (C = u(C, v, x, y, k[f + 14], 23, 4259657740)),
            (y = u(y, C, v, x, k[f + 1], 4, 2763975236)),
            (x = u(x, y, C, v, k[f + 4], 11, 1272893353)),
            (v = u(v, x, y, C, k[f + 7], 16, 4139469664)),
            (C = u(C, v, x, y, k[f + 10], 23, 3200236656)),
            (y = u(y, C, v, x, k[f + 13], 4, 681279174)),
            (x = u(x, y, C, v, k[f + 0], 11, 3936430074)),
            (v = u(v, x, y, C, k[f + 3], 16, 3572445317)),
            (C = u(C, v, x, y, k[f + 6], 23, 76029189)),
            (y = u(y, C, v, x, k[f + 9], 4, 3654602809)),
            (x = u(x, y, C, v, k[f + 12], 11, 3873151461)),
            (v = u(v, x, y, C, k[f + 15], 16, 530742520)),
            (C = u(C, v, x, y, k[f + 2], 23, 3299628645)),
            (y = l(y, C, v, x, k[f + 0], 6, 4096336452)),
            (x = l(x, y, C, v, k[f + 7], 10, 1126891415)),
            (v = l(v, x, y, C, k[f + 14], 15, 2878612391)),
            (C = l(C, v, x, y, k[f + 5], 21, 4237533241)),
            (y = l(y, C, v, x, k[f + 12], 6, 1700485571)),
            (x = l(x, y, C, v, k[f + 3], 10, 2399980690)),
            (v = l(v, x, y, C, k[f + 10], 15, 4293915773)),
            (C = l(C, v, x, y, k[f + 1], 21, 2240044497)),
            (y = l(y, C, v, x, k[f + 8], 6, 1873313359)),
            (x = l(x, y, C, v, k[f + 15], 10, 4264355552)),
            (v = l(v, x, y, C, k[f + 6], 15, 2734768916)),
            (C = l(C, v, x, y, k[f + 13], 21, 1309151649)),
            (y = l(y, C, v, x, k[f + 4], 6, 4149444226)),
            (x = l(x, y, C, v, k[f + 11], 10, 3174756917)),
            (v = l(v, x, y, C, k[f + 2], 15, 718787259)),
            (C = l(C, v, x, y, k[f + 9], 21, 3951481745)),
            (y = n(y, h)),
            (C = n(C, p)),
            (v = n(v, m)),
            (x = n(x, g));
        ...
        r = function(e, t) {
          ...
          if (o) {
            var l,
              d = a.match(/^(https?:\/\/[^\/]+\/)([^\/]*\/?)(.*)$/);
            e.pathStyle
              ? ((l = decodeURIComponent(d[3] || '')), (a = d[1] + d[2]))
              : ((l = decodeURIComponent(d[2] + d[3] || '')), (a = d[1]));
            var f = {
                key: l,
            ...
            for (var p in e.headers)
              e.headers.hasOwnProperty(p) &&
                (p.indexOf('x-cos-meta-') > -1 || h.indexOf(p) > -1) &&
                (f[p] = e.headers[p]);
            i['x-cos-acl'] && (f.acl = i['x-cos-acl']),
    ...
    function(e, t, n) {
      var r = n(11).DOMParser,
        o = function(e) {
          ...
          function u(t, n, r, o) {
            return (
              !(n == A.ELEMENT_NODE && e.xmlElementsFilter.length > 0) ||
          ...
          function l(r, o) {
            if (r.nodeType == A.DOCUMENT_NODE) {
              for (
                var i = new Object(), s = r.childNodes, d = 0;
                d < s.length;
                d++
              ) {
                var f = s.item(d);
            ...
            if (r.nodeType == A.TEXT_NODE || r.nodeType == A.CDATA_SECTION_NODE)
              return r.nodeValue;
          }
          function d(t, n, r, i) {
            var a =
          ...
          function C(t) {
            ...
            return (
              ...
              null != t.__text &&
                (e.escapeMode ? (n += o(t.__text)) : (n += t.__text)),
              n
            );
          }
          function v(t) {
          ...
          function S(e, t) {
            ...
            if (m(e) > 0)
              for (var r in e)
                if (!p(e, r) && ('' == t || g(e, r, x(t, r)))) {
                  var o = e[r],
                    i = y(o);
                  if (null == o || void 0 == o) n += d(o, r, i, !0);
                  else if (o instanceof Object)
                    if (o instanceof Array) n += k(o, r, i, t);
        ...
        i = function(e) {
          ...
          var t = new r(),
            ...
            i = new o(),
            a = i.xml2json(n);
          return a.html && a.getElementsByTagName('parsererror').length
            ? null
            : a;
        };
      e.exports = i;
    ...
    function(e, t) {
      ...
      function r(e, t, n, r, u) {
        ...
        function g(t, n) {
          for (; t >= C && (n = v.exec(e)); )
            (y = n.index), (C = y + n[0].length), x.lineNumber++;
            ...
            switch ((b > A && m(b), e.charAt(b + 1))) {
              case '/':
                var w = e.indexOf('>', b + 3),
                  ...
                  E = k.pop();
                w < 0
                  ? ((_ = e.substring(b + 2).replace(/[\s<].*/, '')),
                    u.error(
                      'end tag name: ' + _ + ' is not complete:' + E.tagName
                    ),
                    (w = b + 1 + _.length))
                  : _.match(/\s</) &&
                    ((_ = _.replace(/[\s<].*/, '')),
                    u.error('end tag name: ' + _ + ' maybe not complete'),
                    (w = b + 1 + _.length));
                var N = E.localNSMap,
                  B = E.tagName == _;
                if (
                  B ||
                  (E.tagName && E.tagName.toLowerCase() == _.toLowerCase())
                ) {
                  if ((r.endElement(E.uri, E.localName, _), N))
                    for (var D in N) r.endPrefixMapping(D);
                  B ||
                    u.fatalError(
                      'end tag name: ' +
                        _ +
              ...
              default:
                ...
                'http://www.w3.org/1999/xhtml' !== O.uri || O.closed
                  ? w++
                  : (w = s(e, w, O.tagName, p, r));
            }
          } catch (e) {
      ...
      var m = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,
        ...
        y = new RegExp(
          '^' + m.source + g.source + '*(?::' + m.source + g.source + '*)?$'
        ),
        C = 0,
        v = 1,
        x = 2,
    ...
    function(e, t, n) {
      ...
      function a(e, t) {
        var n = new u(),
          ...
          d = e.CopySource,
          f = d.match(/^([^.]+-\d+)\.cos(v6)?\.([^.]+)\.[^\/]+\/(.+)$/);
        if (!f) return void t({ error: 'CopySource format error' });
        var h = f[1],
          p = f[3],
        ...
        n.on('copy_slice_complete', function(e) {
          ...
          n.on('get_file_size_finish', function(s) {
            !(function() {
              for (
                var t = [
                  ...
                  o = 0;
                o < t.length &&
                ((n = 1024 * t[o] * 1024), !(y / n <= r.options.MaxPartNumber));
                o++
              );
            ...
            (c =
              ...
              (c = l.clearKey(c)),
              r.multipartInit(
                { Bucket: o, Region: i, Key: a, Headers: c },
                function(r, o) {
                  if (r) return t(r);
    ...
    function(e, t, n) {
      ...
      function r(e, t) {
        ...
        n
          ...
          ee.call(
            this,
            { Action: 'name/cos:GetService', url: n + '/', method: 'GET' },
            function(e, n) {
              if (e) return t(e);
              var r =
                (n &&
      ...
      function u(e, t) {
        ...
        if (e.AccessControlPolicy) {
          var o = re.clone(e.AccessControlPolicy || {}),
            i = o.Grants || o.Grant;
          (i = re.isArray(i) ? i : [i]),
            delete o.Grant,
            delete o.Grants,
            (o.AccessControlList = { Grant: i }),
            (r = re.json2xml({ AccessControlPolicy: o })),
            (n['Content-Type'] = 'application/xml'),
            (n['Content-MD5'] = re.binaryBase64(re.md5(r)));
        }
        ...
        ee.call(
          ...
          function(e, n) {
            if (e)
              ...
              (i = re.clone(re.isArray(i) ? i : [i])),
                re.each(i, function(e) {
                  re.each(
                    [
                      'AllowedOrigin',
                      'AllowedHeader',
      ...
      function d(e, t) {
        ...
        var o = re.json2xml({ CORSConfiguration: { CORSRule: r } }),
          i = e.Headers;
        (i['Content-Type'] = 'application/xml'),
          (i['Content-MD5'] = re.binaryBase64(re.md5(o))),
          ee.call(
            this,
            {
      ...
      function h(e, t) {
        ...
        (o['Content-Type'] = 'application/json'),
          (o['Content-MD5'] = re.binaryBase64(re.md5(r))),
          ee.call(
            this,
            {
      ...
      function C(e, t) {
        ...
        r = re.clone(re.isArray(r) ? r : [r]);
        var o = re.json2xml({ Tagging: { TagSet: { Tag: r } } }),
          i = e.Headers;
        (i['Content-Type'] = 'application/xml'),
          (i['Content-MD5'] = re.binaryBase64(re.md5(o))),
          ee.call(
      ...
      function x(e, t) {
        var n = e.LifecycleConfiguration || {},
          r = n.Rules || [];
        r = re.clone(r);
        var o = re.json2xml({ LifecycleConfiguration: { Rule: r } }),
          i = e.Headers;
        (i['Content-Type'] = 'application/xml'),
          (i['Content-MD5'] = re.binaryBase64(re.md5(o))),
          ee.call(
      ...
      function A(e, t) {
        ...
        var n = e.VersioningConfiguration || {},
          r = re.json2xml({ VersioningConfiguration: n }),
          o = e.Headers;
      ...
      function R(e, t) {
        var n = re.clone(e.ReplicationConfiguration),
          r = re.json2xml({ ReplicationConfiguration: n });
          ...
          ee.call(
            ...
            function(n, r) {
              ...
              (i.Body = r.body),
                r.headers &&
                  r.headers.etag &&
                  (i.ETag = r.headers && r.headers.etag),
                re.extend(i, { statusCode: r.statusCode, headers: r.headers }),
                t(null, i);
            }
          );
      }
      function B(e, t) {
        var n = this,
          r = e.ContentLength,
          o = re.throttleOnProgress.call(n, r, e.onProgress);
        re.getBodyMd5(n.options.UploadCheckContentMd5, e.Body, function(i) {
          i && (e.Headers['Content-MD5'] = re.binaryBase64(i)),
            void 0 !== e.ContentLength &&
              (e.Headers['Content-Length'] = e.ContentLength),
            ee.call(
              n,
              {
      ...
      function D(e, t) {
        ...
        var a = re.throttleOnProgress.call(
          n,
          r['Content-Length'],
          e.onProgress
        );
      ...
      function L(e, t) {
        var n = e.CopySource || '',
          r = n.match(/^([^.]+-\d+)\.cos(v6)?\.([^.]+)\.[^\/]+\/(.+)$/);
        if (!r) return void t({ error: 'CopySource format error' });
        var o = r[1],
          i = r[3],
        ...
        ee.call(
          ...
          {
            Scope: [
              { action: 'name/cos:GetObject', bucket: o, region: i, prefix: a },
              {
                action: 'name/cos:PutObject',
                bucket: e.Bucket,
                region: e.Region,
          ...
          function(e, n) {
            ...
            re.extend(r, { statusCode: n.statusCode, headers: n.headers }),
              t(null, r);
          }
        );
      }
      ...
      function U(e, t) {
        var n = e.Objects || [],
          r = e.Quiet;
        n = re.isArray(n) ? n : [n];
        var o = re.json2xml({ Delete: { Object: n, Quiet: r || !1 } }),
          i = e.Headers;
        (i['Content-Type'] = 'application/xml'),
          (i['Content-MD5'] = re.binaryBase64(re.md5(o)));
      ...
      function j(e, t) {
        var n = e.Headers;
        if (!e.RestoreRequest)
          return void t({ error: 'missing param RestoreRequest' });
        var r = e.RestoreRequest || {},
          o = re.json2xml({ RestoreRequest: r });
        (n['Content-Type'] = 'application/xml'),
          (n['Content-MD5'] = re.binaryBase64(re.md5(o))),
          ee.call(
            this,
            {
      ...
      function K(e, t) {
        ee.call(
          ...
          function(e, n) {
            return e
              ? t(e)
              : (n = re.clone(n || {})) && n.InitiateMultipartUploadResult
              ? t(
                  null,
                  re.extend(n.InitiateMultipartUploadResult, {
                    statusCode: n.statusCode,
                    headers: n.headers
                  })
                )
      ...
      function H(e, t) {
        ...
        re.getFileSize('multipartUpload', e, function() {
          re.getBodyMd5(n.options.UploadCheckContentMd5, e.Body, function(r) {
            r && (e.Headers['Content-MD5'] = re.binaryBase64(r)),
              ee.call(
                n,
                {
      ...
      function z(e, t) {
        for (
          var n = this, r = e.UploadId, o = e.Parts, i = 0, a = o.length;
          i < a;
          i++
        )
          0 !== o[i].ETag.indexOf('"') && (o[i].ETag = '"' + o[i].ETag + '"');
        var s = re.json2xml({ CompleteMultipartUpload: { Part: o } }),
          c = e.Headers;
        (c['Content-Type'] = 'application/xml'),
          (c['Content-MD5'] = re.binaryBase64(re.md5(s))),
          ee.call(
            this,
            {
        ...
        (n.delimiter = e.Delimiter),
          ...
          ee.call(
            ...
            function(e, n) {
              ...
              re.extend(i, { statusCode: n.statusCode, headers: n.headers }),
                t(null, i);
            }
          );
      }
          ...
          function(e, n) {
            if (t) {
              ...
              (o +=
                ...
                n.XCosSecurityToken &&
                  (o += '&x-cos-security-token=' + n.XCosSecurityToken),
                n.ClientIP && (o += '&clientIP=' + n.ClientIP),
                n.ClientUA && (o += '&clientUA=' + n.ClientUA),
      ...
      function Z(e) {
        ...
        var s = o;
        return (
          e.ForcePathStyle && (s += '/' + t),
          (s += '/'),
          a && (s += re.camSafeUrlEncode(a).replace(/%2F/g, '/')),
          e.isLocation && (s = s.replace(/^https?:\/\//, '')),
          s
        );
      }
      function Y(e, t) {
        ...
        var r = function(e) {
            ...
            if (r)
              if (r.indexOf(' ') > -1) n = !1;
                ...
                r.indexOf('q-sign-algorithm=') > -1 &&
                r.indexOf('q-ak=') > -1 &&
                r.indexOf('q-sign-time=') > -1 &&
                r.indexOf('q-key-time=') > -1 &&
                r.indexOf('q-url-param-list=') > -1
              )
                n = !0;
              else
                try {
        ...
        if (!l) {
          ...
          l = e.Scope || [{ action: d, bucket: i, region: a, prefix: f }];
        }
        var h = re.md5(JSON.stringify(l));
        (o._StsCache = o._StsCache || []),
          (function() {
            var e, t;
            for (e = o._StsCache.length - 1; e >= 0; e--) {
              t = o._StsCache[e];
              var n =
                Math.round(re.getSkewTime(o.options.SystemClockOffset) / 1e3) +
                30;
              if ((t.StartTime && n < t.StartTime) || n >= t.ExpiredTime)
                o._StsCache.splice(e, 1);
        ...
        if (
          u.ExpiredTime &&
          u.ExpiredTime - re.getSkewTime(o.options.SystemClockOffset) / 1e3 > 60
        )
          p();
        else if (o.options.getAuthorization)
          o.options.getAuthorization.call(
            o,
            {
              Bucket: i,
              Region: a,
          ...
          o.options.getSTS.call(o, { Bucket: i, Region: a }, function(e) {
            (u = e || {}),
              (u.Scope = l),
              (u.ScopeKey = h),
              (u.TmpSecretId = u.SecretId),
              (u.TmpSecretKey = u.SecretKey),
              o._StsCache.push(u),
              p();
          });
        }
      ...
      function J(e) {
        var t = !1,
          n = !1,
          r = (e.headers && (e.headers.date || e.headers.Date)) || '';
        try {
          var o = e.error.Code,
            i = e.error.Message;
          ('RequestTimeTooSkewed' === o ||
            ('AccessDenied' === o && 'Request has expired' === i)) &&
            (n = !0);
        } catch (e) {}
        if (e)
          if (n && r) {
            ...
            this.options.CorrectClockSkew &&
              Math.abs(re.getSkewTime(this.options.SystemClockOffset) - a) >=
                3e4 &&
      ...
      function ee(e, t) {
        ...
        !e.headers && (e.headers = {}),
          ...
          (e.qs = re.clearKey(e.qs)),
          e.headers && (e.headers = re.clearKey(e.headers)),
          e.qs && (e.qs = re.clearKey(e.qs));
        var r = re.clone(e.qs);
        e.action && (r[e.action] = '');
        var o = function(i) {
          ...
          Y.call(
            ...
            function(r, s) {
              (e.AuthData = s),
                te.call(n, e, function(r, s) {
                  r &&
                  i < 2 &&
                  (a !== n.options.SystemClockOffset || J.call(n, r))
                    ? (e.headers &&
        ...
        if (!r || n._isRunningTask(r)) {
          ...
          (f.headers.Authorization = e.AuthData.Authorization),
            ...
            e.AuthData.XCosSecurityToken &&
              (f.headers['x-cos-security-token'] =
                e.AuthData.XCosSecurityToken),
            f.headers && (f.headers = re.clearKey(f.headers)),
            (f = re.clearKey(f)),
            e.onProgress &&
          ...
          var h = ne(f, function(e, o, i) {
                ...
                s = function(e, i) {
                  if ((r && n.off('inner-kill-task', p), !a)) {
                    ...
                    o && o.statusCode && (s.statusCode = o.statusCode),
                      ...
                      e
                        ? ((e = re.extend(e || {}, s)), t(e, null))
                        : ((i = re.extend(i || {}, s)), t(null, i));
                  }
                };
            ...
            p = function(e) {
              e.TaskId === r &&
                (h && h.abort && h.abort(), n.off('inner-kill-task', p));
            };
      ...
      e.exports.init = function(e, t) {
        t.transferToTaskMethod(oe, 'postObject'),
          re.each(oe, function(t, n) {
          ...
          var t = [],
            ...
            u = function() {
              if (t.length > e.options.UploadQueueSize) {
                ...
                for (
                  n = 0;
                  n < t.length && t.length > e.options.UploadQueueSize && n < a;
                  n++
                )
                  (t[n] && 'waiting' === t[n].state) || (t.splice(n, 1), a--);
              }
            },
            l = function() {
                  ...
                  o[n.api].call(e, s, function(t, r) {
                    e._isRunningTask(n.id) &&
                      (('checking' !== n.state && 'uploading' !== n.state) ||
                        ...
                        'success' === n.state &&
                          (n.params && (delete n.params.Body, delete n.params),
                          delete n.callback)),
                      u());
                  }),
                    c();
            ...
            d = function(t, r) {
              ...
              if (o) {
                var a = o && 'waiting' === o.state,
                  s = o && ('checking' === o.state || 'uploading' === o.state);
                if (
                  ('canceled' === r && 'canceled' !== o.state) ||
                  ('paused' === r && a) ||
                  ('paused' === r && s)
                ) {
                  if (
                  ...
                  (o.state = r),
                    ...
                    s && (i--, l(e)),
                    'canceled' === r &&
                      (o.params && (delete o.params.Body, delete o.params),
                      delete o.callback);
                }
                u();
              }
          ...
          (e._addTasks = function(t) {
            ...
            (e._addTask = function(o, i, a, s) {
              ...
              i.onHashProgress = function(t) {
                e._isRunningTask(f.id) &&
                  ((f.hashPercent = t.percent), h && h(t), c());
              };
              var p = i.onProgress;
              return (
            ...
            (e.restartTask = function(e) {
              ...
              !t ||
                ...
                ((t.state = 'waiting'), c(), (a = Math.min(a, t.index)), l());
            });
        };
