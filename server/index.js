...
// 配置参数
var config = {
  secretId: 'AKIDtiRzMXrQjGi195blxynQxJTfiaHAogDY',
  secretKey: 'JRSN7xlaHqMisEWeg1EG6zlkjcLuMekf',
  proxy: '',
  durationSeconds: 1800,
  bucket: 'guipeisheng-1255991113',
  region: 'ap-beijing',
  allowPrefix: ' guipeisheng-1255991113/*',
  // 密钥的权限列表
  allowActions: [
